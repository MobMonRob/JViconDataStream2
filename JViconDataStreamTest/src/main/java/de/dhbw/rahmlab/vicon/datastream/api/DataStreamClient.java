...
public class DataStreamClient {
     ...
     * @throws IllegalArgumentException if the an invalid device index is selected.
     */
     ...
     * directly to aMulticast address as well. 
     * 
     * You must previously have started a transmission via StartTransmittingMulticast. <p>
     * 
     * @see connect 
     * @see connectToMulticast
     * @see disconnect
     ...
     * 
     * The possible device types are:<p>
     * Unknown
     * ForcePlate
     * EyeTracker
     * 
    ...
    /**
     * Return whether the lightweight transport mode for kinematic segment 
     * data is enabled in the Vicon DataStream.
     * 
     * @see enableSegmentData
     * @see disableSegmentData
     * @see isMarkerDataEnabled
     ...
     * @see isUnlabeledMarkerDataEnabled
     * @see isDeviceDataEnabled
     * @return true, if labeled reconstructed marker data is enabled in the DataStream
     */
     ...
     *   frame has already been processed.<p>
     *
     ...
     *   performance is a problem, try "ClientPullPreFetch" followed by "ServerPush".<p>
     * 
     * @see getFrame
     * @see getLatencyTotal
     ...
     * 
     * <p>This information can be used in conjunction with GetGlobalUnlabeledMarkerTranslation</p>
     * @see getUnlabeledMarkerGlobalTranslation
     * @return the number of unlabeled markers in the DataStream.
     * @throws RuntimeException if no frame is available or the client is not connected
     */
     ...
     * 
     * @param subjectName name of the subject to convert into the corresponding Vicon String type.
     ...
     * 
     * @param segmentName name of the segment to convert into the corresponding Vicon String type.
     ...
     * 
     * @param markerName name of the marker to convert into the corresponding Vicon String type.
     ...
     * 
     * @param frameRateName name of the segment to convert into the corresponding Vicon String type.
     * @return native lib object representation of the given segment name.
     * @throws IllegalArgumentException if the segment is not known.
     */
     ...
     * @throws IllegalArgumentException if the given divice or the given deviceOutputName does not exist
     */
     ...
     *
     * <p>This information can be used in conjunction with GetSegmentName</p>
     * @see getSubjectName
     * @see getSegmentName
     ...
     * @throws RuntimeException if the client is not connected or if no frame is available
     * @throws IllegalArgumentException if is not valid or the segment index is invalid 
     */
     ...
     * @throws IllegalArgumentException if the subject name is invalid or the segment name is invalid.
     * @throws RuntimeException if the client is not connected or no frame is available 
     */
     ...
     * @throws IllegalArgumentException for invalid subject- or segment name
     * @throws RuntimeException if client is not connected or no frame is available
     * @throws UnsupportedOperationException if segment static scale is not supported or not present
     */
     ...
     * 
     * <p>This is only implemented by applications that use an object tracking graph 
     * such as Evoke and Tracker.</p>
     * @see getSubjectCount
     * @see getSubjectName
     * @param subjectName subject name
     * @return the quality score for a speciﬁed Object (Subject). 
     * @throws RuntimeException if client is not connectd or no frame is available
     ...
     *
     * <p>This information can be used in conjunction with GetMarkerName</p>
     * @see getSubjectName
     * @see getMarkerName
     * @param subjectName The name of the subject
     ...
     * @throws IllegalArgumentException if the device name or the deviceOutputName does not exist
     * @throws RuntimeException if the client is not connected or no frame available
     */
     ...
     * @param deviceName device name
     * @param deviceOutputName device output name
     * @return the number of samples available for the specified device at the current frame, -1 if is occluded
     * @throws IllegalArgumentException if the device name or the deviceOutputName does not exist
     * @throws RuntimeException if the client is not connected or no frame available
     */
     ...
     * This version takes a subsample index that allows access to all of the force 
    ...
    * 
    * This version takes a subsample index that allows access to all of the force 
    * information. The vector is in Newton-meters and is with respect to the global 
    * coordinate system, regardless of the orientation of the plate. The vector 
    * represents the moment exerted upon the force plate, not the reaction moment. 
    ...
    */
    ...
    /**
     * Return the number of subsamples available for a specified force plate 
     ...
     * subsample. See the alternate version of this function to access all of 
     * the analog data.
     * 
     * @see getGlobalMomentVector
     * @see getGlobalCentreOfPressure
     ...
     * Return the moment vector for the force plate in global coordinates.
     * 
     * The vector is in Newton-meters and is with respect to the global coordinate 
     * system regardless of the orientation of the force plate. The vector 
     * represents the moment exerted upon the force plate, not the
     ...
     * Return the center of pressure for the force plate in global coordinates.
     * 
     * The position is in millimeters and is with respect to the global coordinate 
     * system. If multiple subsamples are available this function returns the 
     * first subsample. See the alternate version of this function to access
     * all of the analog data.
     * 
     * @see getGlobalForceVector
     * @see getGlobalMomentVector
     * @param forceplateIndex force plate index
     ...
     * 
     * The position is in millimeters with respect to the global origin. 
    ...
    */
    public double[] getSegmentLocalRotationMatrix(String subjectName, String segmentName){ 
        ...
        if (result.getResult() == Result_Enum.InvalidSubjectName) throw new 
                IllegalArgumentException("getSegmentLocalRotationMatrix() but invalid subject name \""+subjectName+"\"!"); 
        if (result.getResult() == Result_Enum.InvalidSegmentName) throw new
                IllegalArgumentException("getSegmentLocalRotationMatrix() but invalid segment name \""+segmentName+"\"!");
