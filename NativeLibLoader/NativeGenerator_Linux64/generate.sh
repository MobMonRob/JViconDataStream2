...
gcc -shared -fPIC -x c -O3 -flto ./src/common/*.c ./src/unix/*.c -o libgluegen_rt.so -I/usr/lib/jvm/default-java/include/linux -I/usr/lib/jvm/default-java/include -Wl,-rpath,'$ORIGIN/.'
