...
%rename (ViconString) ViconDataStreamSDK::CPP::String; //Wichtig! Swig benennt den Java String nicht mit vollst‰ndigem Pfad. Innerhalb des Namespaces gibt es sonst Mehrdeutigkeit.
